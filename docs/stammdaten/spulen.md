...
* [Bobbin volume](../berechnungen/spulen/spulenvolumen.md)
* [Material length on bobbin](../berechnungen/spulen/materiallaenge.md)
* [Runtime and bobbin set](../berechnungen/maschine/laufzeit-spulensatz.md)
